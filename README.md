...
<p>How to optimally tune a PI controller for a car cruise controller using Collimator.</p>
...
<p>How to design and optimize a car suspension system using collimator.</p>
...
<p>How to model a DC motor's speed using different approaches in Collimator.</p>
<p><strong>Difficulty</strong>: Easy.</p></td>
</tbody>
...
<p>How to design a PID controller for controlling the position of a DC motor shaft. We will apply the Ziegler-Nichols method for empirically tuning the PID controller using Collimator.</p>
<p><strong>Difficulty</strong>: Easy.</p></td>
</tbody>
