...
""" 
# Objective
# Tuning a PID controller for a DC Motor Position System
"""
"""
# Project Description
# Using Collimator we will show how to design a PID controller for controlling the position of a DC motor shaft. 
# We will apply the Ziegler-Nichols method for empirically tuning the PID controller.
"""
"""
# Model Requirements
# Import the DC Motor Position TF
"""
...
plt.plot(my_results['time'],my_results['DCMotorPosition'],label="kp = "+str(kp))
plt.legend() 
plt.xlabel("Time")
